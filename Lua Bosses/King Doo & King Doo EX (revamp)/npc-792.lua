...
function sampleNPC.onTickNPC(v)
	...
	if v.collidesBlockLeft or v.collidesBlockRight or v.collidesBlockUp or v.collidesBlockBottom then
		SFX.play(3)
		local ptl = Animation.spawn(10,v.x+v.width/2,v.y+v.height/2)
		ptl.x=ptl.x-ptl.width/2
		ptl.y=ptl.y-ptl.height/2
		local star = NPC.spawn(782,v.x+v.width/2,v.y+v.height/2)
		star.x=star.x-star.width/2
		star.y=star.y-star.height/2
		v:kill(9)
	end
end
